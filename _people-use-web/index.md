...
-   **[Videos of How People with Disabilities Use the Web](/people-use-web/videos/) – links to eighteen 2+minute videos, and 3 compliations {% include image.html src="video.svg" alt="" class="icon" %}
