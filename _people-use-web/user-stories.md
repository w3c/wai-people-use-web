...
* {:.left} [{% include image.html src="profile.png" alt="" %} Alan, reporter with limited use of his arms](/people-use-web/user-stories-one)<br> Alan was involved in a accident which caused a spinal cord injury. This left him with limited use of his arms and no movement or sensation in his legs. He has worked as a reporter for more than 20 years. Alan uses a keyboard with larger keys to help him more easily hit the correct key and a joystick instead of a mouse.
...
* {:.left} [{% include image.html src="profile.png" alt="" %} Lee, online shopper who cannot distinguish between certain colors (color blindness)](/people-use-web/user-stories-four)<br> Lee was born with deuteranopia and protanopia (often called "color blindness"). He has difficulty distinguishing among items that are red, green, orange, and brown, all of which appear kind of a murky brown.
...
* {:.left} [{% include image.html src="profile.png" alt="" %} Martine, older adult student who is deaf](/people-use-web/user-stories-six)<br> Martine has been deaf since birth. She is a mature student, taking online courses. While she can hear some sounds, she does not hear enough to understand speech.
